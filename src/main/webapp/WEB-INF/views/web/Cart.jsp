                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input class="form-control" id="Valor" type="text" oninput="calculateFit();" style="width: 100%" /></td>
                            ...
                            <tr>
                                ...
                                <td>In stock</td>
                                <!--<td><input class="form-control" type="text" value="35"  style="width: 100%"/></td>-->
                                <td><input class="form-control" id="Valor1" type="text" oninput="calculateMexican();" style="width: 100%" /></td>
                                <td class="text-right">25.00 MX</td>
                            ...
                            <tr>
                                ...
                                <td>In stock</td>
                                <!--<td><input class="form-control" type="text" value="35"  style="width: 100%"/></td>-->
                                <td><input class="form-control" id="Valor2" type="text" oninput="calculateMax();" style="width: 100%" /></td>
                                <td class="text-right">25.00 MX</td>
