...
<t:Menu>
  <jsp:body>
    ...
    <div class="container" class="colorMxR">
    <div class="row">
    ...
    <section id="testimonials" class="py-3">
        ...
        <div class="testimonial bg-primary3 row">
        ...
        <div class="testimonial bg-primary3 row">
          <div class="col-xl-6 col-lg-6 col-md-6 col-12" class="testimonial bg-primary3">
        ...
        <div class="testimonial bg-primary3 row">
          <div class="col-xl-6 col-lg-6 col-md-6 col-12" class="testimonial bg-primary3">
            <img src="/images/ensalada.jpg" alt="Camara" class="marg3">
          </div>
        ...
        <div class="testimonial bg-primary3 row">
          <div class="col-xl-6 col-lg-6 col-md-6 col-12" class="testimonial bg-primary3">
            <img src="/images/cereal.jpg" alt="Camara" class="marg3">
          </div>
